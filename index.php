      ...
      <div class="carousel-inner w-100">
          ...
          <div class="d-flex">
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-1.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-8.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-2.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-4.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
        ...
        <div class="carousel-item">
          <div class="d-flex">
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-3.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-5.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-6.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 mb-4 gallery-item">
              <div class="bg-white shadow-sm" style="height: 300px;"><img
                  src="https://bootstrapious.com/i/snippets/sn-gallery/img-7.jpg" alt="" class="img-fluid card-img-top">
                <div class="p-3">
